...
/**
 * Minimal projection of a [MetricFailedMonitorsTable] row used for sampling.
 *
 * @property leafNodeId Decision-tree leaf node assigned to this tick (null if not yet annotated).
 * @property mutantId ID of the mutant evaluated in this tick.
