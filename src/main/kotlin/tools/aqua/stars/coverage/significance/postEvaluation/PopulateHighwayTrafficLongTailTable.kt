...
object PopulateHighwayTrafficLongTailTable {
  fun populate() {
    ...
    println("Starting populating HighwayTrafficLongTailTable.")

    val highwayTrafficLongTailEntries =
        HighwayTrafficScenariosRepository.loadHighwayTrafficLongTailEntries()
    HighwayTrafficLongTailRepository.batchInsert(highwayTrafficLongTailEntries)
    println("Finished populating HighwayTrafficLongTailTable.")
  }
}
