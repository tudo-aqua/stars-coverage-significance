...
/** Simple AutopilotMutant143 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant143 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 196 Id:
     * f4069a8b-1a14-477f-806e-98bb4bb17339, Old Operator: -, New Operator: *
     */
