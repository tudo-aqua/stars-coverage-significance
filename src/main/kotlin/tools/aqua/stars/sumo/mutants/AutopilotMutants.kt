...
fun main() {
  println(
      AutopilotMutants.arithmeticReplacementOperatorMutants
          .take(
              AutopilotMutants.unaryRemovalOperatorMutants.size +
                  AutopilotMutants.logicalReplacementOperatorMutants.size)
          .joinToString(",") { it.first.toString() })
  println(
      (AutopilotMutants.unaryRemovalOperatorMutants +
              AutopilotMutants.logicalReplacementOperatorMutants)
          .joinToString(",") { it.first.toString() })
}
...
object AutopilotMutants {
  ...
  /**
   * All mutants generated by mutant-kraken's [ArithmeticReplacementOperator] operator, keyed by
   * their [byIndex] index.
   */
  ...
  /**
   * All mutants generated by mutant-kraken's [LogicalReplacementOperator] operator, keyed by their
   * [byIndex] index.
   */
  ...
  /**
   * All mutants generated by mutant-kraken's [UnaryRemovalOperator] operator, keyed by their
   * [byIndex] index.
   */
