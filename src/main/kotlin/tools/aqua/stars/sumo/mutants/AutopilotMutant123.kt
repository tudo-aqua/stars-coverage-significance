...
/** Simple AutopilotMutant123 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant123 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 170037cd-3c5c-4dec-bd3f-ce23a95db516, Old Operator: *, New Operator: +
     */
