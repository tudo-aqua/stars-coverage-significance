...
/** Simple AutopilotMutant126 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant126 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 34f6ae75-8352-4a7d-8440-1ed09047a5e7, Old Operator: +, New Operator: %
     */
