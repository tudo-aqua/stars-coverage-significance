...
/** Simple AutopilotMutant145 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant145 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 9cfd4597-5f1b-43ca-a011-274e7f188ed6, Old Operator: +, New Operator: -
     */
