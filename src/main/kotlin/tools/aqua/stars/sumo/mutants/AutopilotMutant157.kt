...
class AutopilotMutant157 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 303 Id:
     * f4ff5f5a-2709-4d82-9791-9d0c364cc4c0, Old Operator: !, New Operator: RemoveOperator
     */
