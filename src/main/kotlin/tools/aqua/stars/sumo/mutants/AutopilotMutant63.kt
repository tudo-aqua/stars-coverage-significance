...
/** Simple AutopilotMutant63 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant63 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 214e451c-f4b6-4146-bdeb-1ef8e34bd8ca, Old Operator: -, New Operator: %
     */
    val vSafe = root % bt
