...
/** Simple AutopilotMutant138 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant138 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 304 Id:
     * 5c273383-e1d2-4bfa-ac19-e7cd93d665d7, Old Operator: !, New Operator: RemoveOperator
     */
