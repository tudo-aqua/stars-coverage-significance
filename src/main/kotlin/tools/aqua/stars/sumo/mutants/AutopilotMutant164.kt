...
/** Simple AutopilotMutant164 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant164 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 158 Id:
       * 27f3f1b3-3dc9-45f3-8d63-2b8fd25e71c6, Old Operator: 0.3, New Operator: 0.1623981
       */
      val penalty = absVal(gapError) * 0.1623981
