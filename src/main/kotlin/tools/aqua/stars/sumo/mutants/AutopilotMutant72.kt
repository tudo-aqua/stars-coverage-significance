...
/** Simple AutopilotMutant72 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant72 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 399 Id:
     * 9863e50b-a361-4248-a6e0-8f8dc636e043, Old Operator: 2, New Operator: -494641372
     */
    val bitAhead = -494641372
