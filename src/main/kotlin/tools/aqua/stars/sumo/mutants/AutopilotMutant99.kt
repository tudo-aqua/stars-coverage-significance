...
/** Simple AutopilotMutant99 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant99 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
       ...
       * Id: 9e7cc43a-2695-49d3-8809-46d06c02ec63, Old Operator: *, New Operator: -
       */
