...
/** Simple AutopilotMutant117 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant117 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 159
       * Id: 12cf09ad-c5a6-4fa6-ac9e-37b346ae37b8, Old Operator: -, New Operator: +
       */
