...
/** Simple AutopilotMutant159 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant159 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 6dfa2c5c-bb96-4876-ace7-b5d66aa4c918, Old Operator: *, New Operator: -
     */
