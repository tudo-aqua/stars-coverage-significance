...
/** Simple AutopilotMutant96 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant96 : Mutant() {
  ...
  private fun clampSpeedWithAccelLimits(vNow: Double, vTarget: Double, dt: Double): Double {
     ...
     * 43cdf74b-f1ff-4de4-9b39-6c7730cb75a0, Old Operator: *, New Operator: +
     */
