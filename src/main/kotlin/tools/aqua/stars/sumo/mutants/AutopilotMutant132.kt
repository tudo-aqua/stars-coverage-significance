...
/** Simple AutopilotMutant132 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant132 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
     ...
     * 3296ecda-83f3-4289-b01e-13c546492965, Old Operator: !, New Operator: RemoveOperator
     */
