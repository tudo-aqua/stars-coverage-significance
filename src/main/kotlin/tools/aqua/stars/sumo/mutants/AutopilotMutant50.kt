...
/** Simple AutopilotMutant50 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant50 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
     ...
     * abd108f2-ff4b-4b35-bc80-eea349708e66, Old Operator: *, New Operator: %
     */
