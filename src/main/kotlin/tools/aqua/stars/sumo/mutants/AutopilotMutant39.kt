...
/** Simple AutopilotMutant39 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant39 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LogicalReplacementOperator Line number: 346 Id:
     * 757ef987-4401-4753-be87-ecde7cd07af6, Old Operator: &&, New Operator: ||
     */
