...
/** Simple AutopilotMutant209 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant209 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 287 Id:
     * e5bffdc6-7fa5-4b38-94a1-61508d207cff, Old Operator: 0, New Operator: -754515558
     */
    val wantRight = dir < -754515558
    val wantLeft = dir > 0
