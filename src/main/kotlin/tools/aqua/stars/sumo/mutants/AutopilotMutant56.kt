...
/** Simple AutopilotMutant56 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant56 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
     ...
     * 00edcbc3-44a6-48ed-98c8-678fa41beee3, Old Operator: 1, New Operator: 887365671
     */
    val bitRight = 887365671
    val bitAhead = 2
