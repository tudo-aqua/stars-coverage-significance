...
/** Simple AutopilotMutant57 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant57 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 362 Id:
     * 018c7e44-81e7-4f93-a57e-1161e4ad5ad8, Old Operator: 0, New Operator: -1189096927
     */
    val wantRight = dir < -1189096927
    val wantLeft = dir > 0
