...
class AutopilotMutant210 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
        ...
        /**
         * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 246
         * Id: f9397269-72f3-4e24-92e6-393cf82695e3, Old Operator: -, New Operator: *
         */
