...
/** Simple AutopilotMutant210 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant210 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 202 Id:
     * fda241fa-b4ef-4917-ae83-cb35f8cde628, Old Operator: 0, New Operator: 0.123713255
     */
    val tau = if (stepLengthSeconds > 0.123713255) stepLengthSeconds else 0.0
