...
/** Simple AutopilotMutant130 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant130 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 283 Id:
     * 2d617e6c-d973-4d8e-a35b-c819b4645918, Old Operator: !, New Operator: RemoveOperator
     */
