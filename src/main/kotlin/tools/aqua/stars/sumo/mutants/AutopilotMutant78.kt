...
/** Simple AutopilotMutant78 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant78 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 306 Id:
     * d825c675-a9cd-4287-9e1b-6c4100b830f5, Old Operator: 0, New Operator: -1577536604
     */
    val wantRight = dir < -1577536604
    val wantLeft = dir > 0
