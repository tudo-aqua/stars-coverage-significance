...
/** Simple AutopilotMutant81 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant81 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 9aaed9d3-6e46-4b62-ba39-b27af7d324f4, Old Operator: *, New Operator: %
     */
