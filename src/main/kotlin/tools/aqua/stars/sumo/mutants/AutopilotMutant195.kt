...
class AutopilotMutant195 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 328 Id:
     * 27ca1d98-ae71-4efa-879f-b98ddf68e3e6, Old Operator: 2, New Operator: -1932769402
     */
    val bitAhead = -1932769402
