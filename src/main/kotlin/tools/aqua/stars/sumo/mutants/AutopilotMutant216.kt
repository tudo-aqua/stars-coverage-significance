...
/** Simple AutopilotMutant216 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant216 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 412 Id:
     * 432c4d10-0350-4ad9-83f0-f338c03c277a, Old Operator: 1, New Operator: 257127684
     */
    val bitRight = 257127684
    val bitAhead = 2
