...
/** Simple AutopilotMutant42 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant42 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 7ee9c914-032e-44e7-917b-453babe61040, Old Operator: -, New Operator: %
     */
