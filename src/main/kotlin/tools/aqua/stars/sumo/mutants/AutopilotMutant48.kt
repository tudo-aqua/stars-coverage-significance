...
/** Simple AutopilotMutant48 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant48 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 72203014-6665-4600-a707-8421e017b3cb, Old Operator: -, New Operator: +
     */
