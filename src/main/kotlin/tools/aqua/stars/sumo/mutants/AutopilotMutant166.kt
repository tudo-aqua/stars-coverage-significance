...
/** Simple AutopilotMutant166 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant166 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LogicalReplacementOperator Line number: 321 Id:
     * 38991b17-11c2-4e01-98c5-cd187abd964a, Old Operator: &&, New Operator: ||
     */
