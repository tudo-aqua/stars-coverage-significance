...
/** Simple AutopilotMutant175 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant175 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * 61577c5b-cc99-434b-8311-66e8da8176e6, Old Operator: 1, New Operator: 75163165
         */
        evaluateLaneChange(
            egoId, dir = 0 - 75163165, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
