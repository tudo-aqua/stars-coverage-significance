...
/** Simple AutopilotMutant90 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant90 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * f6fd9915-ba1b-45d5-bdd9-90449be9fb40, Old Operator: *, New Operator: +
     */
