...
/** Simple AutopilotMutant139 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant139 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 290 Id:
     * 5d58e036-0bde-4925-9800-2f9d694a4bc2, Old Operator: *, New Operator: +
     */
