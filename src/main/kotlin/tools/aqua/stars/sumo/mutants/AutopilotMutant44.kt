...
/** Simple AutopilotMutant44 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant44 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
       ...
       * Id: 89d92f92-30b1-44d0-9337-e5e595b95aa5, Old Operator: -, New Operator: %
       */
