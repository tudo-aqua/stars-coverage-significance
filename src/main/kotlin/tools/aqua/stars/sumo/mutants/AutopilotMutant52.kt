...
/** Simple AutopilotMutant52 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant52 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
     ...
     * e7a00714-c87c-4d06-aae0-62eaec1e42a8, Old Operator: &&, New Operator: ||
     */
