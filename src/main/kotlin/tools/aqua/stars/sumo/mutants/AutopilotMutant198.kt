...
class AutopilotMutant198 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    for (n in neighbors) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 370 Id:
       * 53851963-2023-47b6-a736-c2e45240a992, Old Operator: 0, New Operator: 0.80938125
       */
      if (dist <= 0.80938125) continue
