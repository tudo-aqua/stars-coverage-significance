...
/** Simple AutopilotMutant93 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant93 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
       ...
       * Id: 6f43757c-18ae-45d5-968a-e525f9976b23, Old Operator: *, New Operator: +
       */
