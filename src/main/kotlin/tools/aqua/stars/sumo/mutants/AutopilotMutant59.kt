...
/** Simple AutopilotMutant59 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant59 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 398 Id:
     * 0d94d199-25be-4d0a-8944-c9b41cfe2f0c, Old Operator: 1, New Operator: 2075300461
     */
    val bitRight = 2075300461
    val bitAhead = 2
