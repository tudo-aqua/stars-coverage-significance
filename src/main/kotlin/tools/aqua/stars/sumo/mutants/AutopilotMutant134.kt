...
/** Simple AutopilotMutant134 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant134 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 35e98b64-a50e-481d-a197-c8ddaca52463, Old Operator: !, New Operator: RemoveOperator
     */
