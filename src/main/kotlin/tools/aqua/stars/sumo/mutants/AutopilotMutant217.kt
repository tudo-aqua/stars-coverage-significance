...
/** Simple AutopilotMutant217 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant217 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
     ...
     * 46eb2222-079c-4290-a7ad-bcebf7e297b5, Old Operator: 2, New Operator: 2092618706
     */
    val bitAhead = 2092618706
