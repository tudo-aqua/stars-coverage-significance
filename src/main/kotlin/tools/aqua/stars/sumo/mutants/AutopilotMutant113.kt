...
/** Simple AutopilotMutant113 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant113 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 246 Id:
     * bfe4b22f-79a4-40d1-8037-32eb7b92a45d, Old Operator: -, New Operator: %
     */
