...
/** Simple AutopilotMutant182 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant182 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 206 Id:
     * 2e66a046-1f1d-4609-a351-7d279fea4028, Old Operator: 0, New Operator: 0.7284452
     */
    val netGapClamped = if (netGap > 0.7284452) netGap else 0.0
