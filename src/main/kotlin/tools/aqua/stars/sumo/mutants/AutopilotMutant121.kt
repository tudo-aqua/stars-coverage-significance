...
/** Simple AutopilotMutant121 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant121 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * Id: f824d753-307b-4b2b-bfd7-eb07e6c09c34, Old Operator: -, New Operator: +
         */
