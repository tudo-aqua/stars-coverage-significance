...
/** Simple AutopilotMutant111 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant111 : Mutant() {
  ...
  private fun isStuck(vEgo: Double, vLeader: Double, gap: Double, desiredGap: Double): Boolean {
     ...
     * aad8fbb8-df5b-4de0-9e29-22dc29b01dd8, Old Operator: +, New Operator: /
     */
