...
/** Simple AutopilotMutant189 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant189 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * 5e723ab2-65b6-4ddd-806f-3853d2fc6e8c, Old Operator: 1, New Operator: -882125983
         */
        evaluateLaneChange(
            egoId, dir = 0 - -882125983, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
