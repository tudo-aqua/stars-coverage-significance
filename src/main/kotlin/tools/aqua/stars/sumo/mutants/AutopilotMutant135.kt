...
/** Simple AutopilotMutant135 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant135 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    for (otherId in SumoVehicle.getIDList()) {
       ...
       * Id: 91905da7-5e08-4c37-ba93-1b846e1be5d0, Old Operator: -, New Operator: *
       */
