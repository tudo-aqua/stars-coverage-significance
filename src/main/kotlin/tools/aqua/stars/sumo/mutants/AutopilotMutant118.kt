...
/** Simple AutopilotMutant118 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant118 : Mutant() {
  ...
  private fun clampSpeedWithAccelLimits(vNow: Double, vTarget: Double, dt: Double): Double {
     ...
     * e8d15caf-164f-4d67-9872-2e1dad1c2d41, Old Operator: *, New Operator: %
     */
