...
/** Simple AutopilotMutant37 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant37 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 60 Id:
   * 58030eb6-378f-4419-9aae-4f767880ca90, Old Operator: 0.2, New Operator: 0.4866705
   */
  var relativeSpeedGain = 0.4866705
  /**
