...
/** Simple AutopilotMutant158 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant158 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 278 Id:
     * f7b0b126-ac97-45df-af9c-d6580ed37362, Old Operator: !, New Operator: RemoveOperator
     */
