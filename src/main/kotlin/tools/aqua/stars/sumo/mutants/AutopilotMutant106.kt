...
/** Simple AutopilotMutant106 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant106 : Mutant() {
  ...
  private fun isStuck(vEgo: Double, vLeader: Double, gap: Double, desiredGap: Double): Boolean {
     ...
     * 9c37e1f4-9310-4104-aef7-57e94b30ad46, Old Operator: *, New Operator: /
     */
