...
/** Simple AutopilotMutant219 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant219 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    for (n in neighbors) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 427 Id:
       * 88c15c19-e1d2-464f-b6f9-eb8e87102bab, Old Operator: 0, New Operator: 0.36558557
       */
      if (dist <= 0.36558557) continue
