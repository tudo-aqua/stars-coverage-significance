...
/** Simple AutopilotMutant29 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant29 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 3048faea-eb8d-467d-9887-817c9b9eacb2, Old Operator: -, New Operator: /
     */
