...
/** Simple AutopilotMutant174 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant174 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 193 Id:
     * 5ba23e7b-3f73-49e5-93ce-1359c982dfe3, Old Operator: 0, New Operator: 0.22186577
     */
    val tau = if (stepLengthSeconds > 0.22186577) stepLengthSeconds else 0.0
