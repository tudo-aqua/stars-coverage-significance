...
/** Simple AutopilotMutant102 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant102 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 146 Id:
     * bb68eb21-7c74-4e81-a891-641abcb0790c, Old Operator: -, New Operator: /
     */
