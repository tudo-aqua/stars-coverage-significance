...
/** Simple AutopilotMutant177 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant177 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * f771acb5-38ae-4027-bb4e-ad6f90ce5b65, Old Operator: !, New Operator: RemoveOperator
     */
