...
/** Simple AutopilotMutant110 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant110 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
        ...
        /**
         * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 259
         * Id: b6aef1f4-68b7-4ca6-a718-a550e554904e, Old Operator: -, New Operator: %
         */
