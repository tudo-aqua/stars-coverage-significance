...
/** Simple AutopilotMutant94 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant94 : Mutant() {
  ...
  private fun maybeLaneChange(
     ...
     * 24c56a52-e231-4212-bdd7-b1e686a6dd28, Old Operator: -, New Operator: *
     */
