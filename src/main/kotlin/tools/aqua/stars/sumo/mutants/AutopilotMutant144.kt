...
/** Simple AutopilotMutant144 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant144 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 303 Id:
     * fdad8ce1-03aa-4084-912a-ebf0b6cedea7, Old Operator: -, New Operator: /
     */
