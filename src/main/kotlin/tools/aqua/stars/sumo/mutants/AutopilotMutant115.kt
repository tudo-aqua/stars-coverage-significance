...
/** Simple AutopilotMutant115 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant115 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
        ...
        /**
         * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 249
         * Id: bd0c350b-92ac-400e-9b92-49b0c36432a2, Old Operator: -, New Operator: *
         */
