...
/** Simple AutopilotMutant36 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant36 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
       ...
       * Id: 4e878226-4850-4c79-9b5a-453f6abf5a91, Old Operator: -, New Operator: +
       */
