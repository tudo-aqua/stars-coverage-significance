...
/** Simple AutopilotMutant66 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant66 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 2a9b2964-a038-4f46-9a9a-abd593f60657, Old Operator: *, New Operator: +
     */
