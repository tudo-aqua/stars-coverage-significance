...
class AutopilotMutant222 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 385 Id:
     * b67988d5-648b-43c2-85cf-45eb8f5d03ad, Old Operator: 2, New Operator: -1672205200
     */
    val bitAhead = -1672205200
