...
/** Simple AutopilotMutant155 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant155 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 360 Id:
     * 489c8003-d948-4f39-b57e-72041c17a92c, Old Operator: !, New Operator: RemoveOperator
     */
