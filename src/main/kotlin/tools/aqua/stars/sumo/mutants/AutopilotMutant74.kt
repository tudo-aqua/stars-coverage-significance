...
class AutopilotMutant74 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 371 Id:
     * b52423f8-ceb0-477f-bda4-8f84388339aa, Old Operator: 2, New Operator: -1492318932
     */
    val bitAhead = -1492318932
