...
/** Simple AutopilotMutant201 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant201 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
     ...
     * 6b918b9c-2a09-4ba0-9795-4cd1f4ef2ad3, Old Operator: 0, New Operator: 806484665
     */
    val wantLeft = dir > 806484665
