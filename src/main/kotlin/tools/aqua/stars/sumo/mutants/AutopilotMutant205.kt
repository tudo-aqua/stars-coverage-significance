...
class AutopilotMutant205 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 254 Id:
     * f5587f6f-dcce-4ee8-aaf0-b753a2d28efc, Old Operator: 0, New Operator: 1172323115
     */
    if (targetLaneIndex < 1172323115) return
