...
/** Simple AutopilotMutant205 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant205 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 55 Id:
   * c8e1e328-1475-4e3c-9d68-71751436e392, Old Operator: 9, New Operator: 0.074355125
   */
  var leaderMaxDecelerationInMps2 = 0.074355125
