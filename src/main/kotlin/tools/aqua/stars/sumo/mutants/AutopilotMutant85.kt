...
/** Simple AutopilotMutant85 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant85 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * b5d32a97-ddd9-4b6b-90ce-c4ac0121ee1c, Old Operator: +, New Operator: *
     */
