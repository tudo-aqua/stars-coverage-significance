...
/** Simple AutopilotMutant73 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant73 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 760ee622-a2e3-45b5-aed7-8267a3e0e1eb, Old Operator: *, New Operator: /
     */
