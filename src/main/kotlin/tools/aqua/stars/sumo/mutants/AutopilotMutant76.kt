...
/** Simple AutopilotMutant76 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant76 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 251 Id:
     * c3f123a8-de7a-4e84-b2ab-77a018b70651, Old Operator: 0, New Operator: 180040448
     */
    if (targetLaneIndex < 180040448) return LaneChangeDirection.NO_LANE_CHANGE
