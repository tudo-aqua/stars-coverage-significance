...
/** Simple AutopilotMutant86 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant86 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * b6669d50-e68f-487b-8873-1e62d8a37738, Old Operator: *, New Operator: %
     */
