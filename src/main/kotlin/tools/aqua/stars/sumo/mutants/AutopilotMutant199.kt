...
class AutopilotMutant199 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 351 Id:
     * 5ac4b4cf-368a-41bd-ab76-bfc88cc1776b, Old Operator: 0, New Operator: -664054040
     */
    val wantRight = dir < -664054040
    val wantLeft = dir > 0
