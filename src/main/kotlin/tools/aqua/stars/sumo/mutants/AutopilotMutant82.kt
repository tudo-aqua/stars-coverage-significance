...
/** Simple AutopilotMutant82 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant82 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 9dde3396-16c6-4e52-b9d8-befafa169e35, Old Operator: *, New Operator: /
     */
