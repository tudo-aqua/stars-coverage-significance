...
/** Simple AutopilotMutant125 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant125 : Mutant() {
  ...
  private fun clampSpeedWithAccelLimits(vNow: Double, vTarget: Double, dt: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 218 Id:
     * 182f9cbe-937e-46d6-ad58-6948f5c7353d, Old Operator: -, New Operator: RemoveOperator
     */
