...
class AutopilotMutant140 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    for (otherId in SumoVehicle.getIDList()) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 344
       * Id: dc883a2b-1d2f-45a2-bb15-b3216fc89211, Old Operator: -, New Operator: +
       */
