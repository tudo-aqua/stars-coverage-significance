...
/** Simple AutopilotMutant140 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant140 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 113 Id:
   * 5ea59562-beb3-4a5a-a70c-a6236652a4d9, Old Operator: -, New Operator: RemoveOperator
   */
