...
/** Simple AutopilotMutant148 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant148 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 45 Id:
   * 1189f1e0-4360-448f-a759-1a37b35a13bc, Old Operator: 2.5, New Operator: 0.5736191
   */
  var minGapToLeadingInMeters = 0.5736191
