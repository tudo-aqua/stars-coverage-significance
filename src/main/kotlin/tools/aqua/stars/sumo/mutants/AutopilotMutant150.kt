...
/** Simple AutopilotMutant150 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant150 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * d130331d-4170-4363-a920-9e9310accd56, Old Operator: *, New Operator: -
     */
