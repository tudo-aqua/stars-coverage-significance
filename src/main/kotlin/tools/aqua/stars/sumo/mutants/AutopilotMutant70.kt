...
/** Simple AutopilotMutant70 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant70 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 395 Id:
     * 791ea682-5a47-496e-a10d-5df44d25d1a7, Old Operator: 0, New Operator: -606986030
     */
    val wantLeft = dir > -606986030
