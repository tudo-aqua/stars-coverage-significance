...
/** Simple AutopilotMutant131 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant131 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 7bbd0bb1-32d5-44d0-b04c-9dfe77b34117, Old Operator: +, New Operator: /
     */
