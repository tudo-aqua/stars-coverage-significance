...
class AutopilotMutant77 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 219 Id:
     * 82ddb0ea-3527-4827-95e5-2cacff246da7, Old Operator: -, New Operator: +
     */
    val vSafe = root + bt
