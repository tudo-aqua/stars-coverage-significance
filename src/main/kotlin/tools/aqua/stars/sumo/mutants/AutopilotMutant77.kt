...
/** Simple AutopilotMutant77 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant77 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 363 Id:
     * ca944085-789a-4663-8790-a1fae337da4a, Old Operator: 0, New Operator: 930907471
     */
    val wantLeft = dir > 930907471
