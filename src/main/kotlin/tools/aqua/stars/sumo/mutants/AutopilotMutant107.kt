...
/** Simple AutopilotMutant107 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant107 : Mutant() {
  ...
  private fun maybeLaneChange(
     ...
     * 7d4e8c28-9df5-478f-ad4f-80b5db320266, Old Operator: +, New Operator: *
     */
