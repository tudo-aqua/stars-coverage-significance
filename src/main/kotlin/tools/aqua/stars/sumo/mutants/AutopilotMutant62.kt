...
/** Simple AutopilotMutant62 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant62 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 1d91f6b7-64fb-4af2-9a2f-d407d371a735, Old Operator: -, New Operator: +
     */
    val vSafe = root + bt
