...
/** Simple AutopilotMutant154 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant154 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * ce73379e-462b-49b8-9bc5-0d472c2710ab, Old Operator: *, New Operator: /
     */
