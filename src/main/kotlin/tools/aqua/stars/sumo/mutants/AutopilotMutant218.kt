...
/** Simple AutopilotMutant218 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant218 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 320 Id:
     * 672b70ba-d36e-4f12-a2e8-fbeee0602557, Old Operator: 0, New Operator: -961892740
     */
    val wantRight = dir < -961892740
    val wantLeft = dir > 0
