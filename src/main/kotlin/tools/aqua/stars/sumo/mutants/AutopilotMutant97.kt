...
/** Simple AutopilotMutant97 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant97 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
     ...
     * 9141591f-edaa-46e5-8453-85c3efbed16f, Old Operator: -, New Operator: +
     */
