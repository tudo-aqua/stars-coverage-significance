...
/** Simple AutopilotMutant83 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant83 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * c1ba7635-701a-4a65-a47b-0bcbaa4914a4, Old Operator: -, New Operator: /
     */
    val vSafe = root / bt
