...
/** Simple AutopilotMutant14 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant14 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LogicalReplacementOperator Line number: 354 Id:
     * 44eac833-c48a-4477-abb5-b721a0d8dc7e, Old Operator: &&, New Operator: ||
     */
