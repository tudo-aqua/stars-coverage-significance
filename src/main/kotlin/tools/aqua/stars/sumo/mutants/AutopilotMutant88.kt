...
/** Simple AutopilotMutant88 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant88 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * d2c790ce-18dd-4b43-9dc5-33bb91ab8542, Old Operator: *, New Operator: -
     */
