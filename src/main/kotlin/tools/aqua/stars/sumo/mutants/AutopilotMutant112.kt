...
/** Simple AutopilotMutant112 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant112 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 147 Id:
     * f4f3616d-d0dc-4c4b-bbdf-f5bdc9a8a4ea, Old Operator: -, New Operator: *
     */
