...
/** Simple AutopilotMutant137 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant137 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 306 Id:
     * ab6c6fbb-6064-4021-aceb-bb12f67bdfdc, Old Operator: *, New Operator: %
     */
