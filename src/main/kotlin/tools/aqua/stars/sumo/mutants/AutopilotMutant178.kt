...
/** Simple AutopilotMutant178 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant178 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * f621cc0b-aba6-45db-b27d-aba4844f8ad8, Old Operator: *, New Operator: /
     */
