...
/** Simple AutopilotMutant43 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant43 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 64 Id:
   * 91c84817-7ade-4b7d-b430-fcd3876bef76, Old Operator: 0.6, New Operator: 0.26574552
   */
  var hardBrakeGapFactor = 0.26574552
