...
/** Simple AutopilotMutant129 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant129 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 355 Id:
     * 27302806-b04a-4477-94c6-ffb384ffa477, Old Operator: !, New Operator: RemoveOperator
     */
