...
/** Simple AutopilotMutant120 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant120 : Mutant() {
  ...
  private fun isStuck(vEgo: Double, vLeader: Double, gap: Double, desiredGap: Double): Boolean {
     ...
     * 04b72408-4172-484b-8691-a9a2da26c68e, Old Operator: *, New Operator: %
     */
