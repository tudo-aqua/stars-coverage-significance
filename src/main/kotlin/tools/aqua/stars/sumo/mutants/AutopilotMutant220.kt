...
/** Simple AutopilotMutant220 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant220 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 321 Id:
     * 9fd6747c-fd49-4f01-a85b-7bf301039326, Old Operator: 0, New Operator: 903490389
     */
    val wantLeft = dir > 903490389
