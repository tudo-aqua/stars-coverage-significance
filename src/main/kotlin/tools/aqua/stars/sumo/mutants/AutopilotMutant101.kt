...
/** Simple AutopilotMutant101 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant101 : Mutant() {
  ...
  private fun clampSpeedWithAccelLimits(vNow: Double, vTarget: Double, dt: Double): Double {
     ...
     * 6b6c3bc2-e93e-46d1-a7ee-b46eca36091a, Old Operator: *, New Operator: %
     */
