...
/** Simple AutopilotMutant98 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant98 : Mutant() {
  ...
  private fun maybeLaneChange(
     ...
     * 4be5f036-b44d-4a39-88bd-3317003d844a, Old Operator: -, New Operator: +
     */
