...
/** Simple AutopilotMutant119 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant119 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 253 Id:
     * eda27c64-65df-4581-86a8-889bcef8b209, Old Operator: +, New Operator: /
     */
