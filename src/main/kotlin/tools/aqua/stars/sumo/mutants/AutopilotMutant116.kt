...
/** Simple AutopilotMutant116 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant116 : Mutant() {
  ...
  private fun isStuck(vEgo: Double, vLeader: Double, gap: Double, desiredGap: Double): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 261 Id:
     * c813da47-f924-442e-9eb6-9e6787cf9d2b, Old Operator: *, New Operator: -
     */
