...
class AutopilotMutant152 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 321 Id:
     * d90ba460-9c91-4c0d-ba7c-bb1dfa0e94e0, Old Operator: !, New Operator: RemoveOperator
     */
