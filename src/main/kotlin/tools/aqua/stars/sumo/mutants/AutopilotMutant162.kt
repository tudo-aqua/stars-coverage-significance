...
/** Simple AutopilotMutant162 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant162 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 80c340f1-2173-44f2-ad0b-710f522d19a3, Old Operator: *, New Operator: +
     */
