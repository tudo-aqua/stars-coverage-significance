...
/** Simple AutopilotMutant54 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant54 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LogicalReplacementOperator Line number: 347 Id:
     * ed9e0ced-5c93-45a6-bbcb-236f88b68a7a, Old Operator: &&, New Operator: ||
     */
