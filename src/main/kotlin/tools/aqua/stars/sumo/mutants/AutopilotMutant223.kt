...
/** Simple AutopilotMutant223 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant223 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 376 Id:
     * cf7fe9b2-5db6-4364-9010-335e739909fd, Old Operator: 0, New Operator: 1216604865
     */
    val wantRight = dir < 1216604865
    val wantLeft = dir > 0
