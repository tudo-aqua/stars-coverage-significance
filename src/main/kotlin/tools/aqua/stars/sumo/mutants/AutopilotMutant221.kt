...
/** Simple AutopilotMutant221 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant221 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 377 Id:
     * a49861d5-aeaa-46eb-978f-0040615f13b3, Old Operator: 0, New Operator: -1792427889
     */
    val wantLeft = dir > -1792427889
