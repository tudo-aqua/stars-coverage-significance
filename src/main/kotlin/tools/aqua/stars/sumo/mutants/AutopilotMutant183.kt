...
/** Simple AutopilotMutant183 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant183 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 221 Id:
     * 3d377650-bca8-489c-917e-e79b952cfe86, Old Operator: 0, New Operator: 0.500057
     */
    return if (vSafe > 0.500057) vSafe else 0.0
  }
