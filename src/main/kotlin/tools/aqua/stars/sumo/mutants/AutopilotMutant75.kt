...
/** Simple AutopilotMutant75 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant75 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * c265bc5d-53fa-4860-a8dd-cc5de1a6ff65, Old Operator: 1, New Operator: 905407282
         */
        evaluateLaneChange(
            egoId, dir = 0 - 905407282, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
