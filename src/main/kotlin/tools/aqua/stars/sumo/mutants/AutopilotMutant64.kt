...
/** Simple AutopilotMutant64 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant64 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
        ...
        /**
         * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 246 Id:
         * 3620b590-66e7-4111-817a-1b66707ed9bf, Old Operator: 1, New Operator: 1995836841
         */
        evaluateLaneChange(
            egoId, dir = 0 - 1995836841, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
