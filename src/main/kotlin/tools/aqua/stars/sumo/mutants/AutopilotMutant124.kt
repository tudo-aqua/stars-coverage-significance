...
/** Simple AutopilotMutant124 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant124 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 304 Id:
     * 28375d1a-8154-4593-9bff-28d16d6b0587, Old Operator: *, New Operator: %
     */
