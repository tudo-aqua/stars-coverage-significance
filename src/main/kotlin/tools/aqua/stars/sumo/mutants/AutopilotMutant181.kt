...
/** Simple AutopilotMutant181 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant181 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
        ...
        /**
         * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 249 Id:
         * 8de3794f-81d7-474a-82ff-136033909eea, Old Operator: 1, New Operator: 1328542113
         */
        evaluateLaneChange(
            egoId, dir = 0 - 1328542113, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
