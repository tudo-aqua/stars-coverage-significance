...
class AutopilotMutant181 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 74 Id:
   * 1567a39c-5c48-4139-8117-b568f9017415, Old Operator: 2, New Operator: 0.6494186
   */
  var laneChangeCooldownInSeconds = 0.6494186
