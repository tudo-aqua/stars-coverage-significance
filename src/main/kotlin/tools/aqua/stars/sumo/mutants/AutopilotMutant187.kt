...
/** Simple AutopilotMutant187 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant187 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 89 Id:
   * 55866100-d562-46e6-84a7-6d81ceb69caf, Old Operator: 20, New Operator: 0.8002455
   */
  var laneChangeSideFrontGapInMeters = 0.8002455
