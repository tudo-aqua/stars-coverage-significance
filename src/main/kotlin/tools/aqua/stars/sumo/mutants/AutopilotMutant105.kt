...
/** Simple AutopilotMutant105 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant105 : Mutant() {
  ...
  private fun isStuck(vEgo: Double, vLeader: Double, gap: Double, desiredGap: Double): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 262 Id:
     * 973f0dba-d605-4f35-8551-3825d875a022, Old Operator: +, New Operator: *
     */
