...
/** Simple AutopilotMutant203 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant203 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 264 Id:
     * c21fc2c5-1c51-4be4-a8e5-50964ba9d82a, Old Operator: 0, New Operator: 200405152
     */
    if (targetLaneIndex < 200405152) return LaneChangeDirection.NO_LANE_CHANGE
