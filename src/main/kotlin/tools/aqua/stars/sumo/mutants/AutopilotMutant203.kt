...
class AutopilotMutant203 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 356 Id:
     * aeca30b0-2087-4b90-b30c-f2980797859f, Old Operator: 2, New Operator: 215881136
     */
    val bitAhead = 215881136
