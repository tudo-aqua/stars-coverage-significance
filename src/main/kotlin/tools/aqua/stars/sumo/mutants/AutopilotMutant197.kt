...
/** Simple AutopilotMutant197 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant197 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 352 Id:
     * 4b862c31-5b85-4a8c-97ee-fedcc8e2958a, Old Operator: 0, New Operator: 633668080
     */
    val wantLeft = dir > 633668080
