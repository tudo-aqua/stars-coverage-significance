...
/** Simple AutopilotMutant19 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant19 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 275 Id:
     * d1b1c152-e9d4-44f0-9984-fe029ff4450b, Old Operator: !, New Operator: RemoveOperator
     */
