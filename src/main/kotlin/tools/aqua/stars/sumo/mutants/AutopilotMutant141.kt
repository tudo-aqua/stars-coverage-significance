...
/** Simple AutopilotMutant141 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant141 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * dd802984-f4e6-4df1-847b-a9f20e71628f, Old Operator: -, New Operator: *
     */
