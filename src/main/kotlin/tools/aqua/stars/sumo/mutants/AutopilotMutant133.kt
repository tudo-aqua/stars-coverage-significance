...
/** Simple AutopilotMutant133 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant133 : Mutant() {
  ...
  private fun areAllLanesOnSideFree(egoId: String, dir: Int): Boolean {
    ...
    for (otherId in SumoVehicle.getIDList()) {
       ...
       * Id: 8af758fd-78ae-4b88-bd09-538d3ffdbeb8, Old Operator: -, New Operator: %
       */
