...
class AutopilotMutant153 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 208 Id:
     * 42799893-aefb-4ca0-adc2-a02711cbf9a9, Old Operator: *, New Operator: +
     */
