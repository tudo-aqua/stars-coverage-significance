...
class AutopilotMutant153 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 302 Id:
     * d9bb7f8b-5301-446a-81cc-226f32b0122e, Old Operator: !, New Operator: RemoveOperator
     */
