...
/** Simple AutopilotMutant153 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant153 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 289 Id:
     * 307f6d80-e477-4eb6-920f-d1cda9d35ac3, Old Operator: !, New Operator: RemoveOperator
     */
