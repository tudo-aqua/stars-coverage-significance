...
/** Simple AutopilotMutant146 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant146 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
     ...
     * bdd160da-7632-42c2-9e86-0af8b185ee5a, Old Operator: !, New Operator: RemoveOperator
     */
