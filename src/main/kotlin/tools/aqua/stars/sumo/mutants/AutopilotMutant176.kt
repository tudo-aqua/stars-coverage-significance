...
/** Simple AutopilotMutant176 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant176 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * 65a72c6f-2976-4c10-bf3e-58aba9ef0b79, Old Operator: 0, New Operator: 0.6281806
     */
    val root = if (disc > 0.6281806) sqrt(disc) else 0.0
    val vSafe = root - bt
