...
/** Simple AutopilotMutant61 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant61 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 274 Id:
     * 13f0e4b0-2c07-4637-baae-5c8d46eedefb, Old Operator: 0, New Operator: 1748262737
     */
    val wantLeft = dir > 1748262737
