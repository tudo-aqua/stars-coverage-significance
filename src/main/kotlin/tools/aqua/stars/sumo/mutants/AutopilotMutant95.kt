...
/** Simple AutopilotMutant95 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant95 : Mutant() {
  ...
  private fun maybeLaneChange(
     ...
     * 26ef9868-678b-42b3-bda0-69eeb8da640c, Old Operator: -, New Operator: /
     */
