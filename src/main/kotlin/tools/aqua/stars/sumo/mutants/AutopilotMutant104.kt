...
/** Simple AutopilotMutant104 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant104 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: ArithmeticReplacementOperator Line number: 237 Id:
     * 9616cfb4-8601-4cc8-a12c-a4298089316b, Old Operator: -, New Operator: %
     */
