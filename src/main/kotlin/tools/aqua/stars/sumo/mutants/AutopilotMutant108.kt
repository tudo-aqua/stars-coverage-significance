...
/** Simple AutopilotMutant108 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant108 : Mutant() {
  ...
  private fun maybeLaneChange(
     ...
     * a0e5bbe5-a7db-440f-b37a-33744a73df6a, Old Operator: +, New Operator: -
     */
