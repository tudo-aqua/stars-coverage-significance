...
/** Simple AutopilotMutant69 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant69 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
       ...
       * Id: 4b88e13d-e730-467d-b564-b11b76aa39fd, Old Operator: -, New Operator: /
       */
