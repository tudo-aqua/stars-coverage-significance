...
/** Simple AutopilotMutant79 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant79 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * e2447cd7-796d-478c-9e10-7a914faeace4, Old Operator: 0, New Operator: 0.9980922
     */
    val tau = if (stepLengthSeconds > 0.9980922) stepLengthSeconds else 0.0
