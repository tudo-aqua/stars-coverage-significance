...
/** Simple AutopilotMutant87 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant87 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * b6f0f095-ea7a-4917-bb92-ce0a8aa5954c, Old Operator: +, New Operator: -
     */
