...
class AutopilotMutant204 : Mutant() {
  ...
  private fun getSideLeaderAhead(egoId: String, dir: Int): Neighbor? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 355 Id:
     * d1c6e7c9-bc9d-4a66-8496-dedf787cb92d, Old Operator: 1, New Operator: -596507425
     */
    val bitRight = -596507425
    val bitAhead = 2
