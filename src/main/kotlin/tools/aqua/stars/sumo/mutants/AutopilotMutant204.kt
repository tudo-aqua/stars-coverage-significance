...
class AutopilotMutant204 : Mutant() {
  ...
  private fun desiredSpeedAcc(vEgo: Double, desiredGap: Double, leader: StringDoublePair?): Double {
    ...
    if (gap < hardBrakeGapFactor * desiredGap) {
      ...
      /**
       * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 167 Id:
       * c46b3585-cb39-495c-bf07-edab8ec49cb7, Old Operator: 0.3, New Operator: 0.99581337
       */
      val penalty = absVal(gapError) * 0.99581337
