...
/** Simple AutopilotMutant191 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant191 : Mutant() {
  ...
  private fun evaluateLaneChange(
     ...
     * 65750763-cd9f-4bf1-89d3-966b1cc9fe70, Old Operator: *, New Operator: %
     */
