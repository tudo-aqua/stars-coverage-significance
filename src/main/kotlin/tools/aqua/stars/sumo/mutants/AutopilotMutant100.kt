...
/** Simple AutopilotMutant100 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant100 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * Id: 374da386-8d59-4622-a9d1-24d54e057377, Old Operator: -, New Operator: *
         */
