...
class AutopilotMutant190 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * cd8136ed-a69b-41b5-abb3-c3a688ee5889, Old Operator: 0, New Operator: 0.1606313
     */
    val bLead = if (leaderMaxDecelerationInMps2 > 0.1606313) leaderMaxDecelerationInMps2 else bEgo
