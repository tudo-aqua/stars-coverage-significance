...
/** Simple AutopilotMutant190 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant190 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 201 Id:
     * 65bde37e-d8f4-489f-b92f-c218c0ffcbb3, Old Operator: 0, New Operator: 0.3741889
     */
    val bLead = if (leaderMaxDecelerationInMps2 > 0.3741889) leaderMaxDecelerationInMps2 else bEgo
