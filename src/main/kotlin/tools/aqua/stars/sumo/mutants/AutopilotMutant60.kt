...
/** Simple AutopilotMutant60 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant60 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 209 Id:
     * 0de90db5-7bfd-4f28-8beb-0ced6ea5d02d, Old Operator: 0, New Operator: 0.99964285
     */
    val root = if (disc > 0.99964285) sqrt(disc) else 0.0
    val vSafe = root - bt
