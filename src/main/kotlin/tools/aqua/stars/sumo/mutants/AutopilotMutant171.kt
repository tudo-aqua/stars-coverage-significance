...
/** Simple AutopilotMutant171 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant171 : Mutant() {
  ...
  private fun chooseDirection(left: LaneEval, right: LaneEval): Int? {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: UnaryRemovalOperator Line number: 361 Id:
     * b81067be-cff4-480e-84d0-f86b11bfb0dd, Old Operator: !, New Operator: RemoveOperator
     */
