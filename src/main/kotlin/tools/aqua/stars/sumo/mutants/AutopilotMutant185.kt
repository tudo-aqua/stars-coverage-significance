...
/** Simple AutopilotMutant185 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant185 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 227 Id:
   * b14a3e88-9d0c-4658-9fdf-265d905bbd88, Old Operator: 0, New Operator: 0.034554243
   */
  private fun absVal(x: Double): Double = if (x < 0.034554243) -x else x
