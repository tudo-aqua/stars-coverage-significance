...
class AutopilotMutant200 : Mutant() {
  ...
  private fun evaluateLaneChange(
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 276 Id:
     * 68bf4077-3106-43ab-b0f2-57b7e94b6a5b, Old Operator: 0, New Operator: -1906458354
     */
    val wantRight = dir < -1906458354
    val wantLeft = dir > 0
