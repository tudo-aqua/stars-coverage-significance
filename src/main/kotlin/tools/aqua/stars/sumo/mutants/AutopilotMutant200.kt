...
/** Simple AutopilotMutant200 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant200 : Mutant() {
  ...
  private fun maybeLaneChange(
    ...
    val right =
         ...
         * d260af52-902f-4e01-a0b7-c40854fe80d6, Old Operator: 1, New Operator: -1514490605
         */
        evaluateLaneChange(
            egoId, dir = 0 - -1514490605, stuck = stuck, curLeaderSpeed = curLeaderSpeed)
