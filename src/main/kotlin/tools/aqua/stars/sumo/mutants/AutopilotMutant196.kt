...
class AutopilotMutant196 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 329 Id:
     * 2ac84df5-1da9-4b1d-9beb-b4a417396fa1, Old Operator: 4, New Operator: 1686362791
     */
    val bitBlockingOnly = 1686362791
