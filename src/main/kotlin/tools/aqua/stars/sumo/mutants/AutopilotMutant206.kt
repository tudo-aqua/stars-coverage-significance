...
class AutopilotMutant206 : Mutant() {
  ...
  private fun isTargetDirectionFree(egoId: String, dir: Int): Boolean {
    ...
    /**
     * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 319 Id:
     * fca88295-2884-4b26-ae94-18b37e213b9a, Old Operator: 0, New Operator: -53749549
     */
    val wantRight = dir < -53749549
    val wantLeft = dir > 0
