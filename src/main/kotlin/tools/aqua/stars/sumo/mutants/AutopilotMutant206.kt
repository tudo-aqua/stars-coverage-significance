...
/** Simple AutopilotMutant206 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant206 : Mutant() {
  ...
  /**
   * AUTO GENERATED COMMENT Mutation Operator: LiteralChangeOperator Line number: 61 Id:
   * cdc4f0cd-4585-4178-82d7-692f02f920b9, Old Operator: 0.2, New Operator: 0.64712083
   */
  var relativeSpeedGain = 0.64712083
  /**
