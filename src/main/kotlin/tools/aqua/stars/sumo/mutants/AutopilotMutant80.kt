...
/** Simple AutopilotMutant80 with ACC and Lane Change behavior. Extends [Mutant]. */
class AutopilotMutant80 : Mutant() {
  ...
  private fun safeSpeedKinematic(gapMeters: Double, vLeader: Double): Double {
     ...
     * a8b0dfae-c2c5-4fdb-8389-78741f4967ad, Old Operator: *, New Operator: /
     */
