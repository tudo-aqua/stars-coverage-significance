...
import tools.aqua.stars.data.sumo.xml.dynamicData.CollisionEvent
import tools.aqua.stars.data.sumo.xml.dynamicData.Scenario
...
import tools.aqua.stars.data.sumo.xml.importer.CollisionEventRaw
import tools.aqua.stars.data.sumo.xml.importer.ConnectionRaw
import tools.aqua.stars.data.sumo.xml.importer.EdgeRaw
import tools.aqua.stars.data.sumo.xml.importer.JunctionRaw
import tools.aqua.stars.data.sumo.xml.importer.LaneRaw
import tools.aqua.stars.data.sumo.xml.importer.VehicleTypesFile
import tools.aqua.stars.data.sumo.xml.routeData.FlowDefinition
import tools.aqua.stars.data.sumo.xml.routeData.RouteDefinition
import tools.aqua.stars.data.sumo.xml.routeData.RoutesFile
import tools.aqua.stars.data.sumo.xml.routeData.StopDefinition
import tools.aqua.stars.data.sumo.xml.routeData.TypeParameter
import tools.aqua.stars.data.sumo.xml.routeData.VehicleDefinition
import tools.aqua.stars.data.sumo.xml.routeData.VehicleRouteSpecification
...
import tools.aqua.stars.data.sumo.xml.staticData.ConnectionDirection
import tools.aqua.stars.data.sumo.xml.staticData.ConnectionSignalState
...
import tools.aqua.stars.data.sumo.xml.staticData.ProjToken
import tools.aqua.stars.data.sumo.xml.staticData.ProjValue
import tools.aqua.stars.data.sumo.xml.staticData.Projection
import tools.aqua.stars.data.sumo.xml.staticData.RoadNetwork
