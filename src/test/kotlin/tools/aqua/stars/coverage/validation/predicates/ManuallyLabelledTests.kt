...
import tools.aqua.stars.coverage.significance.tsc.hasVehicleBehindOnSameLane
import tools.aqua.stars.coverage.significance.tsc.hasVehicleBesidesOnLeftLane
import tools.aqua.stars.coverage.significance.tsc.hasVehicleBesidesOnRightLane
import tools.aqua.stars.coverage.significance.tsc.hasVehicleInBehindOnLeftLane
import tools.aqua.stars.coverage.significance.tsc.hasVehicleInFrontOnLeftLane
import tools.aqua.stars.coverage.significance.tsc.hasVehicleInFrontOnSameLane
import tools.aqua.stars.coverage.significance.tsc.isOnMiddleLane
import tools.aqua.stars.coverage.significance.tsc.vehicleOnLeftLaneBehindSameSpeed
import tools.aqua.stars.coverage.significance.tsc.vehicleOnLeftLaneBesideIsSlower
import tools.aqua.stars.coverage.significance.tsc.vehicleOnLeftLaneInFrontIsSlower
import tools.aqua.stars.coverage.significance.tsc.vehicleOnRightLaneBesideIsFaster
import tools.aqua.stars.coverage.significance.tsc.vehicleOnSameLaneBehindIsSlower
