...
Auto-discovers size_<n>/ subdirectories and produces:
  - Per size (full strategies):  size_<n>/draw_ticks_combined.[png|pdf]
  - Per size (rare strategies):  size_<n>/draw_ticks_combined_rare.[png|pdf]
  - All sizes (full strategies): draw_ticks_combined_all.[png|pdf]
  - All sizes (rare strategies): draw_ticks_combined_all_rare.[png|pdf]
